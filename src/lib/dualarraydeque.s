# lib/dualarraydeque.s - DualArrayDeque

.globl	DualArrayDeque_ctor, DualArrayDeque_get, DualArrayDeque_set, DualArrayDeque_add
.globl	DualArrayDeque_remove, DualArrayDeque_log
...
.equ	THIS, -8
.type	DualArrayDeque_ctor, @function
DualArrayDeque_ctor:
	push	%rbp
	mov	%rsp, %rbp
...
.equ	THIS, -8
.equ	LENGTH, -16
.type	DualArrayDeque_length, @function
...
.equ	INDEX, -16
.equ	FRONT_LENGTH, -24
.type	DualArrayDeque_get, @function
DualArrayDeque_get:
	push	%rbp
	mov	%rsp, %rbp
...
.equ	VALUE, -24
.equ	FRONT_LENGTH, -32
.type	DualArrayDeque_set, @function
DualArrayDeque_set:
	push	%rbp
	mov	%rsp, %rbp
...
.equ	VALUE, -24
.equ	FRONT_LENGTH, -32
.type	DualArrayDeque_add, @function
DualArrayDeque_add:
	push	%rbp
	mov	%rsp, %rbp
...
.equ	LENGTH, -16
.equ	CTR, -24
.type	DualArrayDeque_log, @function
DualArrayDeque_log:
	push	%rbp
	mov	%rsp, %rbp
