# proc/handlers/skiplistsset.s - Handler for the skiplistsset command

.include	"common.inc"
.include	"structs.inc"

.globl	skiplistsset, skiplistsset_handler

.section .rodata

skiplistsset:
	.ascii	"skiplistsset\0"
...
handlers:
	.quad	SkiplistSSet_add
	.quad	SkiplistSSet_remove
	.quad	SkiplistSSet_find
...
# @function	skiplistsset_handler
# @description	Handler for the "skiplistsset" command
# @param	%rdi	Pointer to the user input
# @return	void
.equ	INPUT, -8
.equ	COUNTER, -16
.type	skiplistsset_handler, @function
skiplistsset_handler:
	push	%rbp
	mov	%rsp, %rbp
