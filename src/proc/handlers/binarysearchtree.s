# proc/handlers/binarysearchtree.s - Handler for the "binarysearchtree" command

.include	"common.inc"
.include	"structs.inc"

.globl	binarysearchtree, binarysearchtree_handler

.section .rodata

.type	binarysearchtree, @object
binarysearchtree:
	.ascii	"binarysearchtree\0"
...
handlers:
	.quad	BinarySearchTree_add
	.quad	BinarySearchTree_remove
	.quad	BinarySearchTree_find
...
# @function	binarysearchtree_handler
# @description	Handler for the "binarysearchtree" command
# @param	%rdi	Pointer to the input data
# @return	%rax
.equ	INPUT, -8
.equ	COUNTER, -16
.type	binarysearchtree_handler, @function
binarysearchtree_handler:
	push	%rbp
	mov	%rsp, %rbp
